...
A sample implementation for ActivityKit Remote notification server to control Live Activities with push notifications
remotely.
...
1. Obtain a private key (with a .p8 file extension) and a key ID from developer account on
...
1. If you don't have an app already, you can Grab the sample App from my
   [GitHub](https://github.com/0Itsuki0/SwiftUI_LiveActivityWithPushNotification)
